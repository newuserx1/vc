...
# setup
bot_token = os.environ.get("TOKEN", "5853309411:AAEP8YE6_vTsqb30PRtidv45Rww0GKCwxdo") 
api_hash = os.environ.get("HASH", "06651b174c4f0591deb0ed1e5663c996") 
api_id = os.environ.get("ID", "7009965") 
